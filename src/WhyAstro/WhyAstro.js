  ...
  return (
    <div>
      <div className="AstroTech">
        <h1 className="HeadingAstrology">Why Astrology - How we will help!</h1>
        <p><h3 className="HeadingAstrology">Astrology reveals the will of the God</h3>
          ...
          Online Astrology Consultation & Service
          ...
          Stay Updated With Daily Horoscope Predictions & Zodiac Sign
